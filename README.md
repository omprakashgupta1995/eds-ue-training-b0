...
## Environments
- Preview: https://main--eds-ue-training-b0--omprakashgupta1995.aem.page/
- Live: https://main--eds-ue-training-b0--omprakashgupta1995.aem.live/
...
1. Open the `eds-ue-training-b0` directory in your favorite IDE and start coding :)
